...
async function calcSubtract() {
  ...
  // 1. Build the API URL, starting with BASE_URL
  const url = `${BASE_URL}/subtract?a=${numA}&b=${numB}`;
...
async function calcMultiply() {
  ...
  // 1. Build the API URL, starting with BASE_URL
  const url = `${BASE_URL}/multiply?a=${numA}&b=${numB}`;
...
async function calcDivide() {
  ...
  // 1. Build the API URL, starting with BASE_URL
  const url = `${BASE_URL}/divide?a=${numA}&b=${numB}`;
...
function loadCalculator() {
    ...
    document.getElementById('btnSubtract').addEventListener('click', calcSubtract);
    document.getElementById('btnMultiply').addEventListener('click', calcMultiply);
    document.getElementById('btnDivide').addEventListener('click', calcDivide);
  }
